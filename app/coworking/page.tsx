      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <section className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-4 text-slate-600 leading-relaxed">
            ...
            <strong>vedere i dettagli e inviare una richiesta di prenotazione</strong>.
          </p>
        </section>
...
function LocationCard({ location }: { location: Location }) {
  return (
    <article className="rounded-3xl border border-slate-200 bg-white overflow-hidden shadow-sm hover:shadow-md transition group flex flex-col">
      ...
      <div className="p-4 sm:p-5 flex-1 flex flex-col">
        ...
        {/* Link alla scheda sede / slug con modulo prenotazione */}
        <div className="mt-4 pt-3 border-t border-slate-100">
          <Link
            href={`/coworking/${location.slug}`}
            className="inline-flex items-center text-sm font-semibold text-emerald-700 hover:text-emerald-800"
          >
            Apri scheda sede e prenota
