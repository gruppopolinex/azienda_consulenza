...
/* FAQ generiche, adattate se serve */
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <main className="flex-1">
        {/* HERO SOLO TESTO, NESSUN BOX PREZZO */}
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="max-w-4xl space-y-3">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  {gestionale.tag && (
                    <span className="ml-2 inline-flex items-center rounded-full bg-emerald-50 px-2.5 py-1 text-[11px] font-semibold text-emerald-800 border border-emerald-100">
                      {gestionale.tag}
                    </span>
                  )}
                </p>

                <p className="text-sm text-slate-700">{gestionale.description}</p>
              </div>
            </div>
          </div>
        </section>

        {/* CONTENUTO PRINCIPALE: VIDEO + PRICING BOX + FAQ */}
        <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
            {/* COLONNA SINISTRA: video + contenuti testuali */}
                ...
                <div>
                  ...
                  <ul className="mt-3 space-y-2 text-xs text-slate-700">
                    ...
                    <li className="flex items-start gap-2">
                      <Check className="mt-0.5 h-3.5 w-3.5 text-emerald-600" />
                      <span>
                        Tiene sotto controllo <strong>scadenze</strong>,
                        autorizzazioni, monitoraggi e adempimenti.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="mt-0.5 h-3.5 w-3.5 text-emerald-600" />
            ...
            {/* COLONNA DESTRA: unico box pricing + CTA custom */}
            <aside className="space-y-4 lg:space-y-6">
              {/* BOX UNICO: filtro + prezzo + CTA */}
